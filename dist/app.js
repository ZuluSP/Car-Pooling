...
const dropoffRoutes_1 = __importDefault(require("./routes/dropoffRoutes"));
dotenv_1.default.config();
const app = (0, express_1.default)();
app.use(express_1.default.json());
app.use(express_1.default.urlencoded({ extended: true })); // This lets me read x-www-form-urlencoded
app.use(statusRoutes_1.default);
app.use(carRoutes_1.default);
app.use(journeyRoutes_1.default);
app.use(dropoffRoutes_1.default);
exports.default = app;
